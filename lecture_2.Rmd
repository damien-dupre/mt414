...
To publish using GitHub Pages with this easy way, there are 3 requirements:
...
2/ Upload and commit on your GitHub repository all the files contained in the website folder, not the website folder itself.

3/ Then in **GitHub**, click **Settings** -> **Pages** choose:
- `main` branch
- `/docs` folder
- and Save
